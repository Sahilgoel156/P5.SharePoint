...
namespace P5.SharePoint.Data.Schemas
{
    public class SpListItemType : ObjectGraphType<SpListItem>
    {
        public SpListItemType()
        {
            ...
            Field<StringGraphType>("Description", resolve: Context => Context.Source._ExtendedDescription);
            Field<StringGraphType>("DocumentType", resolve: Context => Context.Source.DocumentType);
